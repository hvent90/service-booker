...
$(document).ready(function() {
    ...
    function hourSelection(id) {
        ...
        locations = '<select class="location"><option value="null">Location</option><option value="wsl">Walnut St. Labs</option><option value="ice">ICE</option><option value="evolve">Evolve IP</option><option value="remote">Remote</option></select></span>'
